...
class AlphaBatchNorm(nn.Module):
    ...
    def __init__(self, layer, alpha):
        ...
        super().__init__()
        self.layer = layer # containing the training mean/var
        self.layer.eval()
        self.alpha = alpha

        self.norm = nn.BatchNorm2d(self.layer.num_features, affine=False, momentum=1.0) # used for tracking mean/var of the test batch
